...
import com.gmail.berndivader.mythicmobsext.volatilecode.v1_17_R1.IPacketReceivingHandler;
...
public class PacketReceivingHandler implements IPacketReceivingHandler {
	...
	public Packet<?> handle(PacketPlayInFlying packet) {
		...
		double dx = packet.a(entity_player.locX()), dy = packet.b(entity_player.locY()),
				dz = packet.c(entity_player.locZ());
