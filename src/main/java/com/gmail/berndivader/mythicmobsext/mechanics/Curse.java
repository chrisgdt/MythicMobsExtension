...
public class Curse extends AuraMechanic implements ITargetedEntitySkill {
	...
	public Curse(SkillExecutor manager, File file, String skill, MythicLineConfig mlc) {
		super(manager, file, skill, mlc);
		this.line = skill;
		this.threadSafetyLevel = ThreadSafetyLevel.SYNC_ONLY;

		this.auraName = Optional.ofNullable(mlc.getPlaceholderString(new String[]{"MME_CURSE"}, null));
