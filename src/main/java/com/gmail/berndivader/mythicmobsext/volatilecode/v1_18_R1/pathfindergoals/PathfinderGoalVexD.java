...
public class PathfinderGoalVexD extends PathfinderGoal {
	...
	public void e() {
		...
		if (blockposition == null)
			blockposition = new BlockPosition(entity.locX(), entity.locY(), entity.locZ());
		int i2 = 0;
		while (i2 < 3) {
			BlockPosition blockposition1 = blockposition.b((double) Main.random.nextInt(15) - 7,
					(double) Main.random.nextInt(11) - 5, (double) Main.random.nextInt(15) - 7);
			if (entity.getWorld().isEmpty(blockposition1)) {
