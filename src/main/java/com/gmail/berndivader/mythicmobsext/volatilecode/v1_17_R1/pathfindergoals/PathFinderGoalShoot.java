...
//        this.a.dp();
	...
	public void e() {
		...
		double d2 = this.a.h(entityLiving.locX(), entityLiving.getBoundingBox().e, entityLiving.locZ()); // maxY
		...
		if (--this.d1 == 0) {
			...
			float f3 = f2 = MathHelper.c(d2) / this.i1; // sqrt
			...
			float f4 = MathHelper.c(d2) / this.i1; // sqrt
