...
public class PathfinderGoalFollowEntity extends PathfinderGoal {
	...
	public PathfinderGoalFollowEntity(EntityInsentient entity, EntityLiving entity1, double d0, float f, float f1) {
		...
		c = f;
		b = f1;
		a(EnumSet.of(PathfinderGoal.Type.a, PathfinderGoal.Type.b)); // MOVE LOOK
	...
	public void e() {
		try {
			d.getControllerLook().a(e, 10.0F, (int) d.getClass().getMethod("U").invoke(d)); // Mob#getMaxHeadYRot()
