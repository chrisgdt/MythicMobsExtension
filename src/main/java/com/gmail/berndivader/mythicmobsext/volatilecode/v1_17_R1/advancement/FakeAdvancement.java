package com.gmail.berndivader.mythicmobsext.volatilecode.v1_17_R1.advancement;
...
public class FakeAdvancement {
	private com.gmail.berndivader.mythicmobsext.volatilecode.v1_17_R1.advancement.FakeDisplay display;

	public FakeAdvancement(com.gmail.berndivader.mythicmobsext.volatilecode.v1_17_R1.advancement.FakeDisplay display) {
		this.display = display;
	}

	public com.gmail.berndivader.mythicmobsext.volatilecode.v1_17_R1.advancement.FakeDisplay getDisplay() {
		return this.display;
	}
	...
	public void displayToast(Player player) {
		...
		HashMap<String, Criterion> criterias = new HashMap<>();
		String[][] requirements;
		...
		PacketPlayOutAdvancements packet = new PacketPlayOutAdvancements(false,
				List.of(nmsAdvancement), new HashSet<>(), progresses);
